#!/bin/sh
set -e
WERCKER_RSYNC_SOFT_DEPLOY_SSHKEY="id_rda_batchu.key"
WERCKER_RSYNC_SOFT_DEPLOY_SSHKEY=$WERCKER_SOURCE_DIR/$WERCKER_RSYNC_SOFT_DEPLOY_SSHKEY

# create key file
# $(echo "$WERCKER_RSYNC_SOFT_DEPLOY_PRIVATE_KEY" > $WERCKER_RSYNC_SOFT_DEPLOY_SSHKEY)
